...
const objLat = (obj) => {
    ...
    var text = `my name is ${fName} ${lName} I am ${obj.age} YO, and I love ${obj.hobby}.`;
    return text;
};
// -------------------------------------------------------------------------------------------------------
    ...
    for(let i =0 ; i<arr.length ; i++){
        ...
        if (obj.yearsOfExperience > 1){
            if(obj.firstName == null){
                // obj.firstName = ""
                var newObj = {fullName: `${obj.lastName}`, tech: obj.tech};
            }
            if(obj.lastName == null){
                // obj.lastName = ""
                var newObj = {fullName: `${obj.firstName}`, tech: obj.tech};
            }
            else{
                var newObj = {fullName: `${obj.firstName} ${obj.lastName}`, tech: obj.tech};
            }
            newArr.push(newObj);
        }
    }
